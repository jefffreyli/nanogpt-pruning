...
class GPTConfig:
    ...
    # TR-BERT-style dynamic token reduction
    use_token_reduction: bool = False
    reduction_layers: tuple = (4, 8)  # layers (0-based) where you do token selection
    policy_hidden_dim: int = 256
    lambda_tokens: float = 1e-4       # penalty on #selected tokens
    rl_weight: float = 0.1            # weight of RL loss term vs LM loss
